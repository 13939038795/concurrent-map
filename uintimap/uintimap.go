...
func New(shards int) *ConcurrentHashMap {
	...
	for i := 0; i < shards; i++ {
		m.HashMap[i] = &ConcurrentMapShared{items: make(map[uint]interface{})}
	}
	return m
}
...
type fun func(key uint, oldVal, newVal interface{}) interface{}
